...
/// A button style with a circular shadowed border effect, and an interactive visual effect when pressed. A background
/// is applied depending on the environment colorScheme.
///
/// - Parameters:
...
/// ```
struct ShadowedBorderCircleButtonStyle: PrimitiveButtonStyle
{
    init(
