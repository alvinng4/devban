...
\usepackage[margin=0.7in, tmargin=1in, bmargin=1in]{geometry}
...
\begin{table}[h]
    ...
    \begin{tabular}{cccc}
        ...
        \midrule
        0.0.1 & Ng Ching Yin & \today & Initial release \\
        \bottomrule
    \end{tabular}
...
\input{human_interface_design}
\input{sec_design_and_implementation/sec_design_and_implementation}
\input{acknowledge_ai}
