...
\begin{enumerate}
    ...
    \item Google sign in
\end{enumerate}
For reliable user authentication, we used the Firebase Authentication service. For email
sign up, user must pass the email verification to sign in their account.

\subsubsection{Sequence diagram}
Figure \ref{fig:user_auth_sequence} shows the sequence diagram for user authentication.
...
\begin{figure}[h]
    ...
    \label{fig:user_auth_sequence}d
\end{figure}
...
Figure \ref{} shows the interface for creating a team, and figure \ref{}
shows the sequence diagram for team creation logic.
