...
Figure \ref{fig:ui_login_animation} shows the screenshot of animation after successful login.
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/ui_login_animation.png}
    \caption{The screenshot of animation after successful login}
    \label{fig:ui_login_animation}
\end{figure}
